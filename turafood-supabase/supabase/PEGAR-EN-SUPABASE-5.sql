-- ============================================================================
--  TURAFOOD — EL ARRANQUE: SEIS PREGUNTAS Y EL PANEL A SU MEDIDA
--
--  Pegá TODO esto en:  Supabase -> SQL Editor -> New query -> Run
--
--  Qué hace:
--   1. Guarda lo que contesta cada negocio al entrar (nicho, volumen,
--      cómo le piden hoy, quién reparte, qué le duele, cuándo empieza).
--      NINGUNA pregunta pide datos personales.
--   2. Del nicho deduce el vertical, y del vertical sale la comisión —
--      eso lo decide el servidor, nunca el navegador.
--   3. Deja dos vistas para que veas en dash.turafood.com quién acaba
--      de entrar y a quién llamar primero.
--   4. Lo mismo para repartidores, y les permite registrarse "a pie".
--
