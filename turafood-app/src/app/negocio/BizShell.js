...
const PAGES = {
  ...
  '/negocio/crecimiento/google': ['Google Growth AI', 'Tu ficha y tus campañas en un solo lugar'],
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Google Growth AI', icon: 'travel_explore', href: '/negocio/crecimiento/google' },
